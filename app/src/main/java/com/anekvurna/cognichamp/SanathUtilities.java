...
public class SanathUtilities {
   ...
   // public static Profile currentProfile;
    ...
    {
        editor = context.getSharedPreferences("com.anekvurna.cognichamp", MODE_PRIVATE).edit();
        preferences = context.getSharedPreferences("com.anekvurna.cognichamp", MODE_PRIVATE);
    }
