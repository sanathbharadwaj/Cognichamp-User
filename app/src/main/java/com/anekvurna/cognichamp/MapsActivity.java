...
public class MapsActivity extends DrawerActivity implements OnMapReadyCallback {
    ...
    private void checkForTripRunning(final String driverId) {
        ...
        trackableReference.addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void getDriverLocation(String driverId) {
        ...
        listener = locationReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(latLng).title("Marker at Driver Location").icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_local_taxi_black_24dp)));
                if(first) {
    ...
    void moveCameraToPickUpLocation(LatLng latLng)
    {
        mMap.addMarker(new MarkerOptions().position(latLng)
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_home_black_24dp)).title("PickUp Location"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latLng, 15));
    }
